...
class BaseColors {
  static const Color blackText = const Color(0xFF010101);
  static const Color subText = const Color(0xFF959595);
  static const Color whiteBackground = Color(0xFFFEFFFF);

  static const Color welcomeBackground = const Color(0xFFEFEFEF);
  ...
  static const Color active = const Color(0xFF21D728);
  static const Color rate = const Color(0xFFFEBC3B);
